...
print(type(arr))
# identifies the type of object. Is it numpy, list, tuple, range, boolean etc.?
np.arange(10)
...
np.linspace(2, 9, 4)
# Another method of writing lin-space. Writing start, stop and num is not necessary.
...
# The elements of test_3 array that equals the corresponding element of test_4 array displays "True",
# if not "False" displays.
...
abuja = np.array(lagos, dtype=np.int64)
# The "d-type" in the code is used to force the array to take the given data type.
print(abuja)

practice = np.asarray(lagos, dtype=np.int64)
practice[2] = 10
# Modifying of arrays
print(practice)
print(practice.dtype)
